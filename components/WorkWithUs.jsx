      ...
      <div className="px-6 mx-auto max-w-7xl lg:px-8">
        <div className="max-w-2xl mx-auto lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            We’re always looking for talented individuals to join our team. We
            provide a collaborative environment where everyone is encouraged to
            contribute and make a difference. We offer flexible hours and
            competitive benefits to help you grow both personally and
            professionally. If you’re interested in working with us, check out
